...
function AdminGenerationGuideTab() {
              ...
              {overrides.map((o) => (
                <div key={o.id} className="flex items-center justify-between gap-3 p-3 rounded-lg border border-border text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <Button variant="ghost" size="sm" onClick={() => handleDeleteOverride(o.id)} className="text-destructive hover:text-destructive">
